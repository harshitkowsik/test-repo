...
export const allCourses = [
    // Training & Placement Courses
    {
        ...
        borderColorHover: 'hover:border-indigo-500',
        description: 'Comprehensive training for B.Pharm, D.Pharm, and M.Pharm students with end-to-end placement support.',
        details: ['Industry-oriented lab sessions', 'Corporate visits and exposure', 'Resume building and interview prep', 'Guaranteed placement assistance'],
    ...
    },
    {
        ...
        iconColor: 'text-green-500',
        borderColorHover: 'hover:border-green-500',
        description: 'Enhance your professional communication skills for the global workplace.',
        details: ['Corporate email etiquette', 'Presentation skills', 'Client interaction techniques', 'Cross-cultural communication'],
        imageUrl: 'https://picsum.photos/seed/bizcomm/400/250',
        brochureLink: 'https://docs.google.com/document/d/1Balsy2w-vA2i_g_2j_2L5A4S7s_7f9F/edit?usp=sharing&ouid=106316102379361254399&rtpof=true&sd=true',
    },
];